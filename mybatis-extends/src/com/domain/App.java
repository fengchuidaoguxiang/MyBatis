...
public class App {
    ...
    public void testGetCount(){
            ...
            int row = session.selectOne("com.domain.UserMapper.queryForCount");
            session.close();
            log.info(row);
    }

    /**
     * 查询t_user表中的id列和name列
     */
    @Test
    public void testGetMap(){
        SqlSession session = MyBatisUtils.getSession();
        List<Map<String,Object>> users = session.selectList("com.domain.UserMapper.queryForMap");
